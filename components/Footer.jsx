export default function Footer() {
  return (
    <footer className="w-full bg-blue-900/80 backdrop-blur-md border-t border-white/40 py-4 sm:py-6 mt-4 sm:mt-8 rounded-2xl">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between">
        <span className="text-white font-medium text-center sm:text-left text-sm sm:text-base">
